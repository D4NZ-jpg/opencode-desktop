...
export const dict = {
  ...
  "sidebar.sort.label": "Sortieren",
  "sidebar.sort.projects": "Projekte",
  "sidebar.sort.threads": "Unterhaltungen",
  "sidebar.sort.updatedAt": "Zuletzt aktualisiert",
  "sidebar.sort.createdAt": "Erstellt",
  "sidebar.sort.manual": "Manuell",
  "sidebar.status.processing": "In Bearbeitung",
  "sidebar.status.waiting": "Warten auf Eingabe",
