export const dict = {
  ...
  "sidebar.sort.projects": "프로젝트",
  "sidebar.sort.threads": "스레드",
  "sidebar.sort.updatedAt": "최근 업데이트",
  "sidebar.sort.createdAt": "생성일",
  "sidebar.sort.manual": "수동",
  "sidebar.status.processing": "처리 중",
  "sidebar.status.waiting": "입력 대기 중",
