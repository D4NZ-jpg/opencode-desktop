export const dict = {
  ...
  "sidebar.sort.label": "ترتيب",
  "sidebar.sort.projects": "المشاريع",
  "sidebar.sort.threads": "المحادثات",
  "sidebar.sort.updatedAt": "آخر تحديث",
  "sidebar.sort.createdAt": "تاريخ الإنشاء",
  "sidebar.sort.manual": "يدوي",
  "sidebar.status.processing": "جارٍ المعالجة",
  "sidebar.status.waiting": "بانتظار الإدخال",
