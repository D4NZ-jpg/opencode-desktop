export const dict = {
  ...
  "sidebar.sort.label": "並び替え",
  "sidebar.sort.projects": "プロジェクト",
  "sidebar.sort.threads": "スレッド",
  "sidebar.sort.updatedAt": "最終更新",
  "sidebar.sort.createdAt": "作成日",
  "sidebar.sort.manual": "手動",
  "sidebar.status.processing": "処理中",
