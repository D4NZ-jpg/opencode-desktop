export const dict = {
  ...
  "sidebar.sort.label": "Sortuj",
  "sidebar.sort.projects": "Projekty",
  "sidebar.sort.threads": "Rozmowy",
  "sidebar.sort.updatedAt": "Ostatnio zaktualizowane",
  "sidebar.sort.createdAt": "Utworzone",
  "sidebar.sort.manual": "Ręcznie",
  "sidebar.status.processing": "Przetwarzanie",
  "sidebar.status.waiting": "Oczekiwanie na dane",
