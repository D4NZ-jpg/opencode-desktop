export const dict = {
  ...
  "sidebar.sort.label": "Сортировка",
  "sidebar.sort.projects": "Проекты",
  "sidebar.sort.threads": "Диалоги",
  "sidebar.sort.updatedAt": "Последнее обновление",
  "sidebar.sort.createdAt": "Создано",
  "sidebar.sort.manual": "Вручную",
  "sidebar.status.processing": "Обработка",
  "sidebar.status.waiting": "Ожидание ввода",
