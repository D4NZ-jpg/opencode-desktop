...
export const dict = {
  ...
  "sidebar.sort.projects": "專案",
  "sidebar.sort.threads": "對話",
  "sidebar.sort.updatedAt": "最後更新",
  "sidebar.sort.createdAt": "建立時間",
  "sidebar.sort.manual": "手動",
  "sidebar.status.processing": "處理中",
  "sidebar.status.waiting": "等待輸入",
