export const dict = {
  ...
  "sidebar.sort.projects": "Projetos",
  "sidebar.sort.threads": "Conversas",
  "sidebar.sort.updatedAt": "Última atualização",
  "sidebar.sort.createdAt": "Criado em",
  "sidebar.sort.manual": "Manual",
  "sidebar.status.processing": "Processando",
  "sidebar.status.waiting": "Aguardando entrada",
