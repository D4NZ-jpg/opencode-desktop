export const dict = {
  ...
  "sidebar.sort.label": "Trier",
  "sidebar.sort.projects": "Projets",
  "sidebar.sort.threads": "Conversations",
  "sidebar.sort.updatedAt": "Dernière mise à jour",
  "sidebar.sort.createdAt": "Créé",
  "sidebar.sort.manual": "Manuel",
  "sidebar.status.processing": "En cours",
  "sidebar.status.waiting": "En attente de saisie",
